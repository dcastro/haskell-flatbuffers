    ...
    peopleTables <- W2.writeMany people \person -> do
      ...
      W2.writeTable @Person 3 $ mconcat
        [
          ...
          ,
          W2.writeLocationTableField 1 name
          ,
          W2.writeLocationTableField 2 friends
        ]

    peopleVector <- W2.fromFoldable peopleTables

    W2.writeTable 1 $ W2.writeLocationTableField 0 peopleVector
    ...
    peopleTables <- W3.writeMany people \person -> do
      ...
      W3.writeTable @Person 3 $ mconcat
        [
          ...
          ,
          W3.writeLocationTableField 1 name
          ,
          W3.writeLocationTableField 2 friends
        ]
    peopleVector <- W3.toVector peopleTables

    W3.writeTable 1 $ W3.writeLocationTableField 0 peopleVector
    ...
    peopleTables <- W3C.writeMany people \person -> do
      ...
      W3C.writeTable @Person 3 $ mconcat
        [
          ...
          ,
          W3C.writeLocationTableField 1 name
          ,
          W3C.writeLocationTableField 2 friends
        ]
    peopleVector <- W3C.fromFoldable peopleTables
    W3C.writeTable 1 $ W3C.writeLocationTableField 0 peopleVector
  ...
  W3.encode W3.defaultWriteSettings do
    ...
    (unionLocs, unionTypes) <- W3.writeMany weapons \case
      SwordData str -> do
        ...
        tableLoc <- W3.writeTable 1 $ W3.writeLocationTableField 0 text
    ...
    W3.writeTable 2 $ mconcat
      [ W3.writeLocationTableField 0 unionTypesVec
      , W3.writeLocationTableField 1 unionLocsVec
      ]
